...
import finalTask.service.StudentService.{CourseEvaluation, StudentCoursesOverview, StudentResponse}
...
trait JsonSupport extends SprayJsonSupport {
  ...
  implicit val studentCoursesOverviewFormat = jsonFormat3(StudentCoursesOverview)
  implicit val studentResponseFormat = jsonFormat(StudentResponse, "id", "name", "courses")
  implicit val courseEvaluationFormat = jsonFormat2(CourseEvaluation)
}
